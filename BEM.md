There are too many things on web pages but only one way to style them: CSS. The nature of CSS makes easy things to get out of control. BEM is an approach to write better CSS.
